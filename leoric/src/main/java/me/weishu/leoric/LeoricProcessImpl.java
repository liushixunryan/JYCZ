...
public class LeoricProcessImpl implements ILeoricProcess {
    ...
    public void onDaemonDead() {
        leoricLog("on daemon dead!");
//                String packageName = AppUtils.getAppPackageName();
//        String className = "com.zwl.keeplive.receiver.LocalReceiver";
...
//        mContext.sendBroadcast(explicitIntent);
        if (startServiceByAmsBinder()) {
            ...
            leoricLog("mPid: " + mPid + " current pid: " + pid);
            android.os.Process.killProcess(mPid);
        }
//        String packageName = AppUtils.getAppPackageName();
//        String className = "com.zwl.app2.Service1";
//        ComponentName component = new ComponentName(packageName, className);
//        Intent explicitIntent = new Intent();
//        explicitIntent.setComponent(component);
//        mContext.startService(explicitIntent);
//        String packageName2 = AppUtils.getAppPackageName();
//        String className2 = "com.zwl.app2.Service2";
//        ComponentName component2 = new ComponentName(packageName2, className2);
//        Intent explicitIntent2 = new Intent();
//        explicitIntent2.setComponent(component2);
//        mContext.startService(explicitIntent2);
    }
