...
class OrderListAdapter :
    ...
    override fun convert(holder: BaseViewHolder, item: OrderListBean) {
        ...
        holder.setText(R.id.wtds_tv, item.py_order_code)
        holder.setText(R.id.rwd_tv, item.task_type)
        holder.setText(R.id.ddzt_tv, item.order_state_scan)
        holder.setText(R.id.ddzxs_tv, item.order_num.toString())
        ...
        holder.setText(R.id.xxwcsj_tv, item.order_state_scan_time)
        holder.setText(R.id.xxsmxs_tv, item.scan_num.toString())
        holder.setText(R.id.rcjjsj_tv, item.order_state_scan_hand_time)
        holder.setText(R.id.cph_tv, item.car_number)
        holder.setText(R.id.ddzxss_tv, item.order_num.toString())
