...
public class MmkvHelper {
    ...
    public void putByteArray(String key, byte[] arr) {
        mmkv.encode(key, arr);
    }
    ...
    public void putInt(String key, int arr) {
        mmkv.encode(key, arr);
    }
    ...
    public void putLong(String key, long arr) {
        mmkv.encode(key, arr);
    }
    ...
    public void putString(String key, String arr) {
        mmkv.encode(key, arr);
    }
