...
import cn.ryanliu.jycz.util.ResUtils;
import cn.ryanliu.jycz.util.ThemeUtils;
import cn.ryanliu.jycz.util.Utils;
...
public class MaterialSpinner extends AppCompatTextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        right = bottom = top = ConvertUtils.dp2px(8);
        left = ConvertUtils.dp2px(8);
        ...
        if (!mHideArrow) {
            ...
            int arrowSize = ConvertUtils.dp2px(10);
...
//    }
    ...
    private int calculatePopupWindowHeight() {
        ...
        float listViewHeight = mAdapter.getCount() * ConvertUtils.dp2px(36);
        if (mPopupWindowMaxHeight > 0 && listViewHeight > mPopupWindowMaxHeight) {
